...
export const challenges: Record<Category, Challenge[]> = {
    ...
    // Dare actions - Soft
  {
    ...
    "type": "dare",
    "category": "soft",
    "text": "Fais un massage des épaules à ton partenaire pendant 2 minutes."
},
{
    "id": 52,
    "type": "dare",
    "category": "soft",
    "text": "Chante ta chanson d'amour préférée à ton partenaire."
},
{
    "id": 53,
    "type": "dare",
    "category": "soft",
    "text": "Embrasse ton partenaire tendrement pendant 30 secondes."
},
{
    "id": 54,
    "type": "dare",
    "category": "soft",
    "text": "Dis à ton partenaire 5 choses que tu adores chez lui/elle."
},
{
    "id": 55,
    "type": "dare",
    "category": "soft",
    "text": "Danse lentement avec ton partenaire sur votre chanson préférée."
},
{
    "id": 56,
    "type": "dare",
    "category": "soft",
    "text": "Dessine un cœur sur la main de ton partenaire avec ton doigt."
},
{
    "id": 57,
    "type": "dare",
    "category": "soft",
    "text": "Murmure quelque chose de doux à l'oreille de ton partenaire."
},
{
    "id": 58,
    "type": "dare",
    "category": "soft",
    "text": "Fais un câlin à ton partenaire pendant 1 minute sans parler."
},
{
    "id": 59,
    "type": "dare",
    "category": "soft",
    "text": "Raconte à ton partenaire ton rêve le plus romantique avec lui/elle."
},
{
    "id": 60,
    "type": "dare",
    "category": "soft",
    "text": "Caresse doucement les cheveux de ton partenaire pendant 2 minutes."
},
{
    "id": 61,
    "type": "dare",
    "category": "soft",
    "text": "Écris 'Je t'aime' sur la peau de ton partenaire avec ton doigt."
},
{
    "id": 62,
    "type": "dare",
    "category": "soft",
    "text": "Regarde ton partenaire dans les yeux pendant 1 minute sans parler."
},
{
    "id": 63,
    "type": "dare",
    "category": "soft",
    "text": "Fais semblant de demander ton partenaire en mariage de façon romantique."
},
{
    "id": 64,
    "type": "dare",
    "category": "soft",
    "text": "Masse les pieds de ton partenaire pendant 3 minutes."
},
{
    "id": 65,
    "type": "dare",
    "category": "soft",
    "text": "Raconte à ton partenaire un souvenir précieux que tu as de vous deux."
},
{
    "id": 66,
    "type": "dare",
    "category": "soft",
    "text": "Imite la façon dont ton partenaire dit 'Je t'aime'."
},
{
    "id": 67,
    "type": "dare",
    "category": "soft",
    "text": "Fais un massage des mains à ton partenaire avec de la crème."
},
{
    "id": 68,
    "type": "dare",
    "category": "soft",
    "text": "Décris ton partenaire physiquement comme si tu le voyais pour la première fois."
},
{
    "id": 69,
    "type": "dare",
    "category": "soft",
    "text": "Embrasse délicatement chacun des doigts de ton partenaire."
},
{
    "id": 70,
    "type": "dare",
    "category": "soft",
    "text": "Prépare une boisson pour ton partenaire et sers-la lui romantiquement."
},
{
    "id": 71,
    "type": "dare",
    "category": "soft",
    "text": "Fais une déclaration d'amour théâtrale à ton partenaire."
},
{
    "id": 72,
    "type": "dare",
    "category": "soft",
    "text": "Caresse le visage de ton partenaire pendant que tu le regardes."
},
{
    "id": 73,
    "type": "dare",
    "category": "soft",
    "text": "Raconte à ton partenaire ce que tu aimerais faire avec lui/elle demain."
},
{
    "id": 74,
    "type": "dare",
    "category": "soft",
    "text": "Embrasse le front, les joues et le nez de ton partenaire."
},
{
    "id": 75,
    "type": "dare",
    "category": "soft",
    "text": "Fais un compliment à ton partenaire sur chaque partie de son visage."
},
{
    "id": 76,
    "type": "dare",
    "category": "soft",
    "text": "Tiens les mains de ton partenaire et raconte tes projets avec lui/elle."
},
{
    "id": 77,
    "type": "dare",
    "category": "soft",
    "text": "Imite votre premier baiser ensemble."
},
{
    "id": 78,
    "type": "dare",
    "category": "soft",
    "text": "Fais rire ton partenaire avec ton imitation de quelqu'un."
},
{
    "id": 79,
    "type": "dare",
    "category": "soft",
    "text": "Dessine un petit cœur sur le bras de ton partenaire avec un stylo."
},
{
    "id": 80,
    "type": "dare",
    "category": "soft",
    "text": "Chuchote à ton partenaire tes 3 qualités préférées chez lui/elle."
},
{
    "id": 81,
    "type": "dare",
    "category": "soft",
    "text": "Fais semblant de voir ton partenaire pour la première fois et drague-le/la."
},
{
    "id": 82,
    "type": "dare",
    "category": "soft",
    "text": "Masse les épaules de ton partenaire en lui racontant ta journée."
},
{
    "id": 83,
    "type": "dare",
    "category": "soft",
    "text": "Embrasse la main de ton partenaire comme un gentleman/une lady."
},
{
    "id": 84,
    "type": "dare",
    "category": "soft",
    "text": "Raconte à ton partenaire ton fantasme de week-end parfait ensemble."
},
{
    "id": 85,
    "type": "dare",
    "category": "soft",
    "text": "Caresse le bras de ton partenaire de haut en bas très lentement."
},
{
    "id": 86,
    "type": "dare",
    "category": "soft",
    "text": "Fais une sérénade à ton partenaire avec une chanson inventée."
},
{
    "id": 87,
    "type": "dare",
    "category": "soft",
    "text": "Regarde ton partenaire manger quelque chose que tu lui donnes."
},
{
    "id": 88,
    "type": "dare",
    "category": "soft",
    "text": "Raconte à ton partenaire ce qui t'a séduit chez lui/elle au début."
},
{
    "id": 89,
    "type": "dare",
    "category": "soft",
    "text": "Dessine vos initiales entrelacées quelque part sur le corps de ton partenaire."
},
{
    "id": 90,
    "type": "dare",
    "category": "soft",
    "text": "Fais un bisou à ton partenaire sur une partie de son corps au choix."
},
{
    "id": 91,
    "type": "dare",
    "category": "soft",
    "text": "Raconte à ton partenaire un rêve que tu as fait avec lui/elle récemment."
},
{
    "id": 92,
    "type": "dare",
    "category": "soft",
    "text": "Caresse la nuque de ton partenaire pendant qu'il/elle ferme les yeux."
},
{
    "id": 93,
    "type": "dare",
    "category": "soft",
    "text": "Fais deviner à ton partenaire ce que tu penses de lui/elle avec des mimes."
},
{
    "id": 94,
    "type": "dare",
    "category": "soft",
    "text": "Embrasse la tempe de ton partenaire et murmure quelque chose de doux."
},
{
    "id": 95,
    "type": "dare",
    "category": "soft",
    "text": "Raconte à ton partenaire pourquoi tu l'as choisi(e)."
},
{
    "id": 96,
    "type": "dare",
    "category": "soft",
    "text": "Fais un massage du cuir chevelu à ton partenaire."
},
{
    "id": 97,
    "type": "dare",
    "category": "soft",
    "text": "Dis à ton partenaire ce que tu aimerais que vous fassiez ensemble ce soir."
},
{
    "id": 98,
    "type": "dare",
    "category": "soft",
    "text": "Caresse le contour du visage de ton partenaire avec tes doigts."
},
{
    "id": 99,
    "type": "dare",
    "category": "soft",
    "text": "Raconte à ton partenaire ce qui te rend heureux/heureuse avec lui/elle."
},
{
    "id": 100,
    "type": "dare",
    "category": "soft",
    "text": "Fais un câlin à ton partenaire par derrière pendant 2 minutes."
}
