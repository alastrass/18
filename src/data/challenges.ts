...
export const challenges: Record<Category, Challenge[]> = {
  ...
  intense: [
    ...
    { id: 101, type: 'truth', category: 'intense', text: "Quel est ton fantasme le plus audacieux avec moi ?" },
    ...
    { id: 119, type: 'truth', category: 'intense', text: "Quel scénario de séduction aimerais-tu qu'on joue ?" },
    ...
    { id: 134, type: 'truth', category: 'intense', text: "Quel aspect de ma séduction trouves-tu irrésistible ?" },
    ...
    { id: 151, type: 'dare', category: 'intense', text: "Fais-moi un massage sensuel du dos pendant 5 minutes" },
    { id: 152, type: 'dare', category: 'intense', text: "Embrasse mon cou avec passion pendant 1 minute" },
    ...
    { id: 155, type: 'dare', category: 'intense', text: "Danse pour moi de façon séductrice" },
    { id: 156, type: 'dare', category: 'intense', text: "Embrasse une partie de mon corps de ton choix pendant 2 minutes" },
    { id: 157, type: 'dare', category: 'intense', text: "Fais-moi un massage des cuisses avec de l'huile" },
    ...
    { id: 161, type: 'dare', category: 'intense', text: "Embrasse-moi partout sauf sur la bouche pendant 3 minutes" },
    { id: 162, type: 'dare', category: 'intense', text: "Utilise tes lèvres pour explorer mon décolleté" },
    { id: 163, type: 'dare', category: 'intense', text: "Fais-moi un massage complet du corps pendant 10 minutes" },
    ...
    { id: 166, type: 'dare', category: 'intense', text: "Embrasse l'intérieur de mes poignets sensuellement" },
    { id: 167, type: 'dare', category: 'intense', text: "Fais-moi un massage des pieds très sensuel" },
    ...
    { id: 172, type: 'dare', category: 'intense', text: "Fais-moi un massage abdominal très doux" },
    ...
    { id: 175, type: 'dare', category: 'intense', text: "Caresse l'intérieur de mes bras avec tes ongles" },
    { id: 176, type: 'dare', category: 'intense', text: "Fais-moi un baiser français passionné de 2 minutes" },
    ...
    { id: 180, type: 'dare', category: 'intense', text: "Embrasse mes épaules pendant 3 minutes" },
    ...
    { id: 186, type: 'dare', category: 'intense', text: "Utilise ta bouche pour explorer ma clavicule" },
    { id: 187, type: 'dare', category: 'intense', text: "Fais-moi un massage du ventre avec de l'huile chaude" },
    ...
    { id: 192, type: 'dare', category: 'intense', text: "Caresse l'arrière de mes genoux sensuellement" },
    { id: 193, type: 'dare', category: 'intense', text: "Utilise différentes pressions pour me masser" },
    { id: 194, type: 'dare', category: 'intense', text: "Embrasse ma tempe pendant que tu me caresses" },
    { id: 195, type: 'dare', category: 'intense', text: "Fais-moi découvrir une nouvelle zone érogène" },
    { id: 196, type: 'dare', category: 'intense', text: "Caresse ma peau avec une plume pendant 5 minutes" },
    ...
    { id: 200, type: 'dare', category: 'intense', text: "Caresse-moi pendant 5 minutes sans t'arrêter" }
  ]
};